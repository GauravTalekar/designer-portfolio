    ...
    <header className="h-screen mt-10 flex items-center justify-center relative overflow-hidden magicpattern">
      ...
      <div className="text-center mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <div className="hero-social-wrapper flex justify-center text-2xl md:text-3xl mt-6">
            {
              socials.map((social, idx) =>
                <Link
                  className="cursor-pointer bg-shark-950 p-3 m-3 rounded-lg font-bold text-cerise-600 hover:text-dull-lavender-600 transition duration-300 ease-in"
                  title={social.title}
                  href={social.link}
                  target="_blank"
